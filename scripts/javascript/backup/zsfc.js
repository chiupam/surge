 ...
 * script-path: https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.js
 * requests-body: 1
 * 
 * type: cron
 * cron: 0 10 0 * * *
 ...
 * 
 * =============== Surge ===============
 * 掌上飞车Cookie = type=http-request, pattern=^https://mwegame\.qq\.com/ams/sign/doSign/month, requires-body=1, max-size=-1, script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.js, script-update-interval=0, timeout=5
 * 掌上飞车 =type=cron, cronexp="0 10 0 * * *", wake-system=1, script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.js, script-update-interval=0, timeout=5
 * 
 * =============== Loon ===============
 * http-request ^https://mwegame\.qq\.com/ams/sign/doSign/month script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.js, requires-body=true, timeout=10, tag=掌上飞车Cookie
 * cron "0 10 0 * * *" script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.js, tag=掌上飞车
 * 
 * =============== Quan X ===============
 * ^https://mwegame\.qq\.com/ams/sign/doSign/month url script-request-body https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.js
 * 0 10 0 * * * https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.js, tag=掌上飞车, enabled=true
 * 
*/
