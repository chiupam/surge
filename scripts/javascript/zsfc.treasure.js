 ...
 * script-path: https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.treasure.js
 * requests-body: 1
 *
 * type: cron
 * cron: 0 0-59/10 17 * * *
 ...
 *
 * =============== Surge ===============
 * 掌飞寻宝Cookie = type=http-request, pattern=^https?://bang\.qq\.com/app/speed/treasure/index\?*, requires-body=true, max-size=-1, script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.treasure.js, script-update-interval=0, timeout=70
 * 掌飞寻宝 =type=cron, cronexp="0 0-59/10 17 * * *", wake-system=1, script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.treasure.js, script-update-interval=0, timeout=600
 *
 * =============== Loon ===============
 * http-request ^https?://bang\.qq\.com/app/speed/treasure/index\?* script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.treasure.js, requires-body=true, timeout=70, tag=掌飞寻宝Cookie
 * cron "0 0-59/10 17 * * *" script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.treasure.js, tag=掌飞寻宝
 *
 * =============== Quan X ===============
 * ^https?://bang\.qq\.com/app/speed/treasure/index\?* url script-request-body https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.treasure.js
 * 0 0-59/10 17 * * * https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.treasure.js, tag=掌飞寻宝, enabled=true
 *
 */
