 ...
 * script-path: https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.shop.js
 * requests-body: 1
 *
 * type: cron
 * cron: 0 11 0,21 * * *
 ...
 *
 * =============== Surge ===============
 * 掌飞购物Cookie = type=http-request, pattern=^https?://bang\.qq\.com/app/speed/mall/main2\?*, requires-body=1, max-size=-1, script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.shop.js, script-update-interval=0, timeout=10
 * 掌飞购物 =type=cron, cronexp="0 11 0,21 * * *", wake-system=1, script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.shop.js, script-update-interval=0, timeout=60
 *
 * =============== Loon ===============
 * http-request ^https?://bang\.qq\.com/app/speed/mall/main2\?* script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.shop.js, requires-body=true, timeout=10, tag=掌飞购物Cookie
 * cron "0 11 0,21 * * *" script-path=https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.shop.js, tag=掌飞购物
 *
 * =============== Quan X ===============
 * ^https?://bang\.qq\.com/app/speed/mall/main2\?* url script-request-body https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.shop.js
 * 0 11 0,21 * * * https://raw.githubusercontent.com/chiupam/surge/main/scripts/javascript/zsfc.shop.js, tag=掌飞购物, enabled=true
 *
 */
